...
#ifndef RINGMVP_SWIFT_H
#define RINGMVP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ringmvp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7ringmvp11RingManager")
...
SWIFT_CLASS("_TtC7ringmvp20TideCameraController")
@interface TideCameraController : NSObject <AVCapturePhotoCaptureDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
